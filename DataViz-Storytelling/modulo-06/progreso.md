# Progreso: Módulo 06 - Storytelling y Narrativa
...
- **Tipo**: 
- **Dataset**: 
- **Archivo**: modulo-06-grafico-1.png
- **Descripción**: 

### Visualización 2
- **Tipo**: 
- **Dataset**: 
- **Archivo**: modulo-06-grafico-2.png
- **Descripción**: 
...
- [ ] `modulo-06-grafico.png`
- [ ] `modulo-06-datos.csv`
- [ ] `modulo-06-resultados.json`
