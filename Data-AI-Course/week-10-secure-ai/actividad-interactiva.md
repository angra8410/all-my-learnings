# Actividades Interactivas - Week 10: Secure AI Development

## 🎯 Objective

Master secure ai development through hands-on exercises with verification steps.
...
### Objective
Apply secure ai development concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-10-exercise-1
   cd week-10-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-10-exercise-2
   cd week-10-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-10-exercise-3
   cd week-10-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-10-exercise-4
   cd week-10-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-10-exercise-5
   cd week-10-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-10-exercise-6
   cd week-10-exercise-6
   ```
