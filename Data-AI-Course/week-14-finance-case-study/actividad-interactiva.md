# Actividades Interactivas - Week 14: FINANCE: Loan Default Prediction

## 🎯 Objective

Master finance: loan default prediction through hands-on exercises with verification steps.
...
### Objective
Apply finance: loan default prediction concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-14-exercise-1
   cd week-14-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-14-exercise-2
   cd week-14-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-14-exercise-3
   cd week-14-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-14-exercise-4
   cd week-14-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-14-exercise-5
   cd week-14-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-14-exercise-6
   cd week-14-exercise-6
   ```
