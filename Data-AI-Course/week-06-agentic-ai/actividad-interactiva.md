# Actividades Interactivas - Week 6: Agentic AI Development

## 🎯 Objective

Master agentic ai development through hands-on exercises with verification steps.
...
### Objective
Apply agentic ai development concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-06-exercise-1
   cd week-06-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-06-exercise-2
   cd week-06-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-06-exercise-3
   cd week-06-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-06-exercise-4
   cd week-06-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-06-exercise-5
   cd week-06-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-06-exercise-6
   cd week-06-exercise-6
   ```
