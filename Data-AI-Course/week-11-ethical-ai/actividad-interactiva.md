# Actividades Interactivas - Week 11: Ethical AI Practices

## 🎯 Objective

Master ethical ai practices through hands-on exercises with verification steps.
...
### Objective
Apply ethical ai practices concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-11-exercise-1
   cd week-11-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-11-exercise-2
   cd week-11-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-11-exercise-3
   cd week-11-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-11-exercise-4
   cd week-11-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-11-exercise-5
   cd week-11-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-11-exercise-6
   cd week-11-exercise-6
   ```
