# Actividades Interactivas - Week 5: Prompt Tools & Tooling

## 🎯 Objective

Master prompt tools & tooling through hands-on exercises with verification steps.
...
### Objective
Apply prompt tools & tooling concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-05-exercise-1
   cd week-05-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-05-exercise-2
   cd week-05-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-05-exercise-3
   cd week-05-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-05-exercise-4
   cd week-05-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-05-exercise-5
   cd week-05-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-05-exercise-6
   cd week-05-exercise-6
   ```
