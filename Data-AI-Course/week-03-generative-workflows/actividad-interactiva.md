# Actividades Interactivas - Week 3: Building Generative AI Workflows

## 🎯 Objective

Master building generative ai workflows through hands-on exercises with verification steps.
...
### Objective
Apply building generative ai workflows concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-03-exercise-1
   cd week-03-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-03-exercise-2
   cd week-03-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-03-exercise-3
   cd week-03-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-03-exercise-4
   cd week-03-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-03-exercise-5
   cd week-03-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-03-exercise-6
   cd week-03-exercise-6
   ```
