# Actividades Interactivas - Week 4: Python for AI

## 🎯 Objective

Master python for ai through hands-on exercises with verification steps.
...
### Objective
Apply python for ai concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-04-exercise-1
   cd week-04-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-04-exercise-2
   cd week-04-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-04-exercise-3
   cd week-04-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-04-exercise-4
   cd week-04-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-04-exercise-5
   cd week-04-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-04-exercise-6
   cd week-04-exercise-6
   ```
