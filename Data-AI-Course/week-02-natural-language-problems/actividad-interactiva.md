# Actividades Interactivas - Week 2: Solving Natural Language Problems

## 🎯 Objective

Master solving natural language problems through hands-on exercises with verification steps.
...
### Objective
Apply solving natural language problems concepts to solve real problems.
...
1. **Setup**
   ...
   mkdir week-02-exercise-1
   cd week-02-exercise-1
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-02-exercise-2
   cd week-02-exercise-2
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-02-exercise-3
   cd week-02-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-02-exercise-4
   cd week-02-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-02-exercise-5
   cd week-02-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-02-exercise-6
   cd week-02-exercise-6
   ```
