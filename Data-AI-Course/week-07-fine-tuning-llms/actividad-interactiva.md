# Actividades Interactivas - Week 7: Fine-Tuning & Instruction-Tuning LLMs

## 🎯 Objective

Master fine-tuning & instruction-tuning llms through hands-on exercises with verification steps.
...
### Objective
Apply fine-tuning & instruction-tuning llms concepts to solve real problems.
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-07-exercise-3
   cd week-07-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-07-exercise-4
   cd week-07-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-07-exercise-5
   cd week-07-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-07-exercise-6
   cd week-07-exercise-6
   ```
