# Actividades Interactivas - Week 8: Evaluating Generative AI Solutions

## 🎯 Objective

Master evaluating generative ai solutions through hands-on exercises with verification steps.
...
### Objective
Apply evaluating generative ai solutions concepts to solve real problems.
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-08-exercise-3
   cd week-08-exercise-3
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-08-exercise-4
   cd week-08-exercise-4
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-08-exercise-5
   cd week-08-exercise-5
   ```
...
1. **Setup**
   ```bash
   # Create working directory
   mkdir week-08-exercise-6
   cd week-08-exercise-6
   ```
